...
const Sidebar = () => {
  ...
  return (
    <div className={`fixed top-12 left-0 bottom-12 bg-gray-300 z-50 bg-opacity-80 backdrop-blur-sm transition-transform duration-300 ${isVisible ? 'translate-x-0' : '-translate-x-full'} shadow-lg`}>
